...
## Included Examples
- **[Infinite Reach](https://steamcommunity.com/sharedfiles/filedetails/?id=3690921373)** 
- **[Ignore Plane Blocking](https://steamcommunity.com/sharedfiles/filedetails/?id=3690921326)** 
- **[No Chasms](https://steamcommunity.com/sharedfiles/filedetails/?id=3690945809)** 
...
The Infinite Reach and Ignore Plane Blocking mods use the Harmony framework:  
https://github.com/pardeike/Harmony  

You should not include Harmony yourself. Instead:

- Add "harmony_support" as a dependency in the mod json file. 
- Subscribe to [the mod](https://steamcommunity.com/sharedfiles/filedetails/?id=3690921150) on Steam Workshop
...
4. Optional:  
   ...
   - preview.png  (640x360 recommended)
